...
from PyQt5.QtWidgets import QMainWindow, QAction, QVBoxLayout, QWidget, QTableWidget, QTableWidgetItem, QHeaderView, QDateEdit, QComboBox, QLabel, QHBoxLayout, QPushButton, QTabWidget, QCalendarWidget
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        # Set font
        font = QFont("Bookman Old Style", 14)
        self.setFont(font)
    ...
    def showDayTasks(self):
        ...
        tasks = self.db.get_tasks_for_date(selected_date.toString("yyyy-MM-dd"))
